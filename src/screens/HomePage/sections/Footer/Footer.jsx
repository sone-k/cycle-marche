...
const SocialIcon = ({ href, children, label }) => (
  <a
    ...
    className="w-12 h-12 flex items-center justify-center rounded-full hover:opacity-70 transition-opacity"
...
export const Footer = () => {
  return (
    <div
      className="w-full mt-20 py-12 px-8 mt-60"
    ...
    >
      ...
      >
        ...
        >
          Copyright © サイクルマルシェ. All rights reserved.
        </p>
      </div>
    </div>
  );
